...
1. **[1] Ahaggach et al.** — Sales forecasting trends survey.
2. **[4] Long et al.** — Scalable probabilistic GB trees.
3. **[7] Hewage et al.** — 3-phase promo lifecycle analysis.
...
6. **[16] Kumar et al.** — SHAP feature interaction for supply chains.
7. **[19] Ansari et al.** — Chronos-2: Foundation models for forecasting.
...
2. **[6] Geurts & Nagaraj** — Measuring true lift, halo, cannibalization.
...
5. **[15] A. K. Sharma et al.** — Comparative stability of SHAP, LIME, Attention.
6. **[18] Y. Liu et al.** — Transformers vs. Linear effectiveness.
7. **[21] J. Zhang et al.** — Hybrid XGBoost-LSTM for multi-store data.
8. **[24] X. Long et al.** — Retraining frequency impact on forecast stability.
...
Meet at "Technical Intersection" points:

- **Promotional Task Force (A-7, B-5, B-8, C-3, C-6):** FR-08 cannibalization proxy definitions.
- **XAI Workshop (A-16, B-14, C-15):** SHAP interpretation methodology for FR-07 module.
- **Data Integrity Circle (A-10, B-11, C-9, C-27):** Feature engineering pipeline (FR-03) leakage-prevention best practices.